...
public class DataUtilitiesTest {
	...
	@Test
	public void testDataContainsNullColumn() {
		DefaultKeyedValues2D testValues = new DefaultKeyedValues2D();
		testValues.addValue(null, 0, 0);
		assertEquals("Wrong output returned, should be 0", 0, DataUtilities.calculateColumnTotal(testValues, 0), 0.0000001d);
	}
	...
	@Test
	public void testDataContainsNullRow() {
		DefaultKeyedValues2D testValues = new DefaultKeyedValues2D();
		testValues.addValue(null, 0, 0);
		assertEquals("Wrong output returned, should be 0", 0, DataUtilities.calculateRowTotal(testValues, 0), 0.0000001d);
	}
	...
	@Test
	public void testDataContainsNullCumulativePercentages() {
		DefaultKeyedValues testVals = new DefaultKeyedValues();
		testVals.addValue("0", null);
		assertEquals("Wrong output returned, should be 0", 0.0, (double)DataUtilities.getCumulativePercentages(testVals).getValue("0"), 0.0000001d);
	}
}
